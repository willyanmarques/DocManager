            ...
            <form action="srcDocumento.php" method="POST"> <!-- FORM -->
              ...
              <div class="col-md-2">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="dataDe" placeholder="dd/mm/aaaa" class="form-control pull-right" id="dataDe" autocomplete="on" required >
                </div>
              </div>
              ...
              <div class="col-md-2">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="dataAte" placeholder="dd/mm/aaaa" class="form-control pull-right" id="dataAte" autocomplete="on"  required >
                </div>
              </div>
